...
export const AvatarManWithBackFill = ({
  componentName,
  additionalClassName,
  height,
  width,
...
AvatarManWithBackFill.propTypes = {
  /**
...
AvatarManWithBackFill.defaultProps = {
  componentName: "avatar-man-with-BackFill",
};
