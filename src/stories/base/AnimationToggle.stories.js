...
const AnimationToggles = {
  ...
  argTypes: {
    animationType: {
      control: {
        type: "select",
        options: ["bounce", "bounceDown", "bounceUp", "fade", "flip", "lightSpeedRight", "lightSpeedLeft","lightSpeedLeftToRight","rotate", "roll","zoom", "slideDown", "slideUp", "slideDownToSlideUp", "slideUpToSlideDown", "slideLeft","slideRight"],
      },
    },
  },
};
